...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    healthCheck(variables?: HealthCheckQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<HealthCheckQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<HealthCheckQuery>(HealthCheckDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'healthCheck');
    }
  };
}
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  fileUpload?: Resolver<Maybe<ResolversTypes['FileUploadResponse']>, ParentType, ContextType, RequireFields<MutationFileUploadArgs, 'file'>>;
}>;

export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  healthCheck?: Resolver<Maybe<ResolversTypes['HealthCheckResponse']>, ParentType, ContextType, RequireFields<QueryHealthCheckArgs, never>>;
}>;
